 ...
 * the lightweight SPV mode, a {@link com.google.monacoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.monacoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
